...
model=pickle.load(open("Jupyter Notebook\model.pkl","rb"))
...
# Converting the categorical values into intergers
    ...
    return render_template('index.html', prediction_text = 'Credit Card Default Status for account {} : {}'.format(acc_no, output))
